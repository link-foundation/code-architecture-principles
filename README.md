...
- **Small Public Surface**  
  Expose as few public functions, classes, or endpoints as possible. Keep the rest internal to reduce accidental misuse.
...
- **Validation at Boundaries**  
  Validate input when it enters the system (e.g., HTTP request, queue message) so inner code can assume it is well-formed.
...
- **Simplicity Over Cleverness**  
  Prefer simple, boring solutions that are easy to read and maintain over tricky, “smart” solutions.
